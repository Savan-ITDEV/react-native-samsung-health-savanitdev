...
package com.samsunghealthsavanitdev.utils
...
class DailyIntakeCalories {
    ...
    fun convertToWritableMap(nutritionInfo: NutritionInfo): WritableMap {
        val map = Arguments.createMap()
        map.putString("title", nutritionInfo.title)
        map.putString("protein", nutritionInfo.protein.toString())
        map.putString("totalFat", nutritionInfo.totalFat.toString())
        map.putString("saturatedFat", nutritionInfo.saturatedFat.toString())
        map.putString("polySaturatedFat", nutritionInfo.polySaturatedFat.toString())
        map.putString("monoSaturatedFat", nutritionInfo.monoSaturatedFat.toString())
        map.putString("transFat", nutritionInfo.transFat.toString())
        map.putString("carbohydrate", nutritionInfo.carbohydrate.toString())
        map.putString("dietaryFiber", nutritionInfo.dietaryFiber.toString())
        map.putString("sugar", nutritionInfo.sugar.toString())
        map.putString("cholesterol", nutritionInfo.cholesterol.toString())
        map.putString("sodium", nutritionInfo.sodium.toString())
        map.putString("potassium", nutritionInfo.potassium.toString())
        map.putString("vitaminA", nutritionInfo.vitaminA.toString())
        map.putString("vitaminC", nutritionInfo.vitaminC.toString())
        map.putString("calcium", nutritionInfo.calcium.toString())
        map.putString("iron", nutritionInfo.iron.toString())
        return map
    }
}
